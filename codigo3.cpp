...
//Exercise 3: Producto maximo de dos numeros en una secuencia, dada una secuencia de n numeros no negativos mayores de 0. encontrar el mayor numero
// que se pueda obtener multiplicando dos numeros de esa secuencia
